      ...
      <section style={{
        ...
        <div className="page-header" style={{ marginBottom: "40px", textAlign: "center" }}>
          ...
          <p style={{
            ...
            maxWidth: "360px",
            fontWeight: 500
          }}>Welcome to your easy and smart parking experience! </p>
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: "16px", alignItems: "center", width: "100%" }}>
          <button className="primary-btn" style={{ width: "100%", maxWidth: "280px", padding: "16px", fontSize: "1.1rem" }} onClick={() => navigate("/login")}>
            Sign In
          </button>
        </div>
      </section>
